        ...
        <div className='w-60 h-80 cursor-pointer group perspective'>
            ...
            <div className='relative bg-[#07080D] preserve-3d group-hover:my-rotate-y-180 w-full h-full duration-1000 rounded-lg'>
                <div className='absolute inset-0 flex items-center justify-center'>
                    <img src={Borders} className='w-full h-full object-cover m-2' alt='Borders' />
                </div>
                <div className='absolute flex flex-col items-center backface-hidden w-full h-full space-y-9'>
                    ...
                    <div className='border border-white rounded-lg p-8 m-8 bg-[#0D0E13]'>
                        <p className='text-xs text-white text-center'>Do I have to be a top talent to participate?</p>
                    </div>
                </div>
