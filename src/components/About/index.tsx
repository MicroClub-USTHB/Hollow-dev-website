    ...
    <div className="text-textColor font-font flex flex-col items-center gap-6 py-10 xl:px-32 md:px-28 px-10  bg-black">
      ...
      <div className=" bg-dark p-10 rounded-2xl grid md:grid-cols-2 lg:grid-cols-2 sm:grid-cols-1 justify-between border-customBlue border  w-full">
        ...
        <div>
          ...
          <p className=' text-[15px] w-60 pb-10'>The IT Section, one of three key sections at Micro Club, The section offers activities like bootcamps and hackathons.</p>
        </div>
      ...
      <div className=" grid xl:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-6 ">
        ...
        <div className=" bg-dark  p-10 rounded-2xl border-customBlue border  ">
          ...
          <p className=' font-bold text-4xl pb-3'>What is hollow dev?
          </p>
          <p className='text-[15px]'>Hollow Dev is an online hackathon focused on backend development and building server-side software, where each team will have to solve challenges.</p>
        </div>
