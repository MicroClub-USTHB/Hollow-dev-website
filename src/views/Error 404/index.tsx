...
function ErrorPage() {
  return (
    <div className="flex items-center relative justify-center h-screen w-screen bg-cover bg-no-repeat bg-center overflow-hidden"
      ...
      <div className="flex-col text-center space-y-10">
        ...
        <Link to="/" className="relative space-x-2 bg-[#000000] rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center cursor-pointer">
