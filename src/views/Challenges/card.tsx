...
export default function Card(props:any) {
  return(
    ...
    <div className={`border-2  relative rounded-sm  h-96 w-72 shadow-2xl ${props.shadow} transition-shadow duration-300`}>
      <img src={props.url} className=' w-48 h-full w-full  opacity-60 '/>
